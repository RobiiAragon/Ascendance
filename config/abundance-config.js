...
window.USERS_DATABASE = {
    // === ADMINISTRATORS ===
    'gisellebrambila89@gmail.com': {
        id: 'admin-giselle',
        email: 'gisellebrambila89@gmail.com',
...
window.ROLE_PERMISSIONS = {
    ...
    'employee': {
        ...
        color: '#3b82f6', // Blue
        // Page Access Permissions
        pages: ['celesteai', 'clockin', 'newstuff', 'abundancecloud', 'transfers', 'announcements', 'schedule', 'help', 'training', 'supplies', 'dailychecklist', 'change', 'risknotes', 'gforce', 'projectanalytics', 'labels', 'treasury', 'glabs', 'restock', 'thechamps']
    }
};
