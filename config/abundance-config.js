...
window.ROLE_PERMISSIONS = {
    ...
    'manager': {
        ...
        color: '#f59e0b', // Amber
        // Page Access Permissions
        pages: ['dashboard', 'employees', 'licenses', 'analytics', 'invoices', 'vendors', 'cashout', 'treasury', 'announcements', 'clockin', 'restock', 'supplies', 'dailychecklist', 'transfers', 'change', 'gifts', 'risknotes', 'gforce', 'passwords', 'projectanalytics', 'issues', 'schedule', 'labels']
    },
    'employee': {
        // Action Permissions
        ...
        color: '#3b82f6', // Blue
        // Page Access Permissions
        pages: ['clockin', 'newstuff', 'abundancecloud', 'transfers', 'announcements', 'schedule', 'help', 'training', 'supplies', 'dailychecklist', 'change', 'risknotes', 'gforce', 'projectanalytics', 'labels']
    }
};
