...
window.ROLE_PERMISSIONS = {
    'admin': {
        ...
        pages: ['celesteai', 'podmatcher', 'dashboard', 'employees', 'training', 'licenses', 'leases', 'analytics', 'salesperformance', 'newstuff', 'restock', 'supplies', 'dailychecklist', 'abundancecloud', 'transfers', 'stores', 'announcements', 'tasks', 'schedule', 'settings', 'help', 'thieves', 'invoices', 'issues', 'vendors', 'clockin', 'dailysales', 'cashout', 'gconomics', 'treasury', 'change', 'customercare', 'employeepurchases', 'incidentlog', 'risknotes', 'gforce', 'passwords', 'projectanalytics', 'labels', 'hrapplications', 'glabs', 'activitylog', 'thechamps', 'timeoffrequests']
    },
    'manager': {
        // Action Permissions
        canViewAllEmployees: true,
    ...
    'employee': {
        ...
        color: '#3b82f6', // Blue
        // Page Access Permissions
        pages: ['celesteai', 'podmatcher', 'clockin', 'newstuff', 'abundancecloud', 'transfers', 'announcements', 'schedule', 'help', 'training', 'supplies', 'dailychecklist', 'change', 'incidentlog', 'risknotes', 'gforce', 'projectanalytics', 'labels', 'treasury', 'glabs', 'thechamps', 'issues', 'thieves', 'timeoffrequests']
    }
};
