...
window.ROLE_PERMISSIONS = {
    ...
    'employee': {
        ...
        color: '#3b82f6', // Blue
        // Page Access Permissions
        pages: ['celesteai', 'podmatcher', 'clockin', 'newstuff', 'abundancecloud', 'transfers', 'announcements', 'schedule', 'help', 'training', 'supplies', 'dailychecklist', 'change', 'incidentlog', 'gforce', 'projectanalytics', 'labels', 'treasury', 'glabs', 'thechamps', 'issues', 'thieves', 'timeoffrequests', 'shiftexchanges', 'employeepurchases', 'restock', 'devlog']
    }
};
